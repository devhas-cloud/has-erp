...
@section('styles')
    <style>
        ...
        .task-form-section.open .task-form-section-body {
            display: block;
        }

        .task-form-section-header .chevron {
            transition: transform 0.2s;
            font-size: 11px;
            color: var(--text-muted);
        }

        .task-form-section.open .chevron {
                            ...
                            <div class="form-group">
                                ...
                                <select name="division_id">
                                    ...
                                    @foreach ($divisions as $div)
                                        <option value="{{ $div->id }}"
                                            {{ $task->division_id == $div->id ? 'selected' : '' }}>
                                            {{ $div->division_name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-row">
                            <div class="form-group small">
                                ...
                                <select name="alert_type">
                                    <option value="none" {{ $task->alert_type == 'none' ? 'selected' : '' }}>None
                                    </option>
                                    <option value="email" {{ $task->alert_type == 'email' ? 'selected' : '' }}>Email
                                    </option>
                                    <option value="whatsapp" {{ $task->alert_type == 'whatsapp' ? 'selected' : '' }}>
                                        WhatsApp</option>
                                    <option value="both" {{ $task->alert_type == 'both' ? 'selected' : '' }}>Both
                                    </option>
                                </select>
                            </div>
                            <div class="form-group small">
                                ...
                                <select name="alert_target">
                                    <option value="personal" {{ $task->alert_target == 'personal' ? 'selected' : '' }}>
                                        Personal</option>
                                    <option value="group" {{ $task->alert_target == 'group' ? 'selected' : '' }}>Group WA
                                    </option>
                                    <option value="both" {{ $task->alert_target == 'both' ? 'selected' : '' }}>Both
                                    </option>
                                </select>
                            </div>
                            <div class="form-group small">
                                <label>Alert Time</label>
                                <input type="datetime-local" name="alert_time"
