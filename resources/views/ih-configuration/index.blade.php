...
@section('title', 'IH Configuration')
@section('page-title', 'IH Configuration')

@section('content')
<div class="page-header">
    <div>
        <h1 class="page-header-title">IH Configuration</h1>
        <p class="page-header-sub">Kelola konfigurasi quotation (pH, Ammonia, COD, TSS dan Debit) dari task quote</p>
    </div>
    @if($canCreate)
    <div class="page-header-actions">
        <a href="{{ route('ih-configuration.create') }}" class="btn-accent">
...
<div class="card-custom fade-in">
    ...
    <div class="card-body-custom p-2">
        <div class="table-responsive">
            <table id="ih-config-table" class="table table-custom align-middle mb-0" style="width:100%">
                <thead>
                    <tr>
...
const wcShowUrl = '{{ route("ih-configuration.show", "__ID__") }}';
const wcEditUrl = '{{ route("ih-configuration.edit", "__ID__") }}';
const wcDeleteUrl = '{{ route("ih-configuration.destroy", "__ID__") }}';
...
const wcShowUrlBase = '{{ route("ih-configuration.show", "__ID__") }}';
...
function initWcTable() {
    ...
    wcTable = $('#ih-config-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route("ih-configuration.data") }}',
        order: [[1, 'desc']],
        columns: [
