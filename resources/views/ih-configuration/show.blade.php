...
<div class="page-header">
    <div>
        ...
        <p class="page-header-sub">IH Configuration dari Task Quote #{{ $quotation->task_id }}</p>
    </div>
    <div class="page-header-actions">
        ...
        @else
            <a href="{{ route('ih-configuration.index') }}" class="btn btn-secondary btn-sm">
                <i class="fa fa-arrow-left me-1"></i> Kembali
            </a>
        @endif
        <a href="{{ route('ih-configuration.pdf', $quotation->id) }}" target="_blank" class="btn-accent">
...
<div class="wc-action-bar justify-content-end">
    <a href="{{ route('ih-configuration.edit', $quotation->id) }}" class="btn btn-primary btn-sm">
        ...
        <div class="card-custom mt-4">
            ...
            <div class="card-body-custom">
                ...
                <div class="alert alert-info py-2 px-3 mt-3 mb-0" style="font-size:12px">
                    ...
                    Aturan: user divisi IH (pembuat) tidak bisa approve dokumennya sendiri. Approval hanya dapat
                    dilakukan oleh user lain yang satu divisi dengan pembuat (divisi IH).
                </div>
            </div>
        </div>
    </div>
...
const wcSubmitUrl = '{{ route("ih-configuration.submit", "__ID__") }}';
const wcApproveUrl = '{{ route("ih-configuration.approve", "__ID__") }}';
const wcRejectUrl = '{{ route("ih-configuration.reject", "__ID__") }}';
const wcUnlockUrl = '{{ route("ih-configuration.unlock", "__ID__") }}';
const wcReviseUrl = '{{ route("ih-configuration.revise", "__ID__") }}';
const wcVersionsUrl = '{{ route("ih-configuration.versions", "__ID__") }}';
const wcEditUrl = '{{ route("ih-configuration.edit", "__ID__") }}';
