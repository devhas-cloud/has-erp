...
@section('title', $quotation ? 'Edit IH Configuration #'.$quotation->id : 'Buat IH Configuration')
@section('page-title', $quotation ? 'Edit IH Configuration' : 'Buat IH Configuration')
...
<div class="page-header">
    <div>
        <h1 class="page-header-title">{{ $quotation ? 'Edit IH Configuration #'.$quotation->id : 'Buat IH Configuration' }}</h1>
...
<form id="wc-form" autocomplete="off">
    ...
    <div class="d-flex justify-content-end gap-2 mb-4">
        <a href="{{ route('ih-configuration.index') }}" class="btn btn-secondary">Batal</a>
...
const wcStoreUrl = '{{ route("ih-configuration.store") }}';
const wcUpdateUrl = '{{ route("ih-configuration.update", "__ID__") }}';
const wcIndexUrl = '{{ route("ih-configuration.index") }}';
const wcSearchUrl = '{{ route("ih-configuration.search-products") }}';
const wcFetchTaskUrl = '{{ route("ih-configuration.fetch-task") }}';
const wcFetchTemplateUrl = '{{ route("ih-configuration.fetch-template", "__ID__") }}';
