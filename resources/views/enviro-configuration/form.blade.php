...
@section('title', $quotation ? 'Edit Enviro Configuration #'.$quotation->id : 'Buat Enviro Configuration')
@section('page-title', $quotation ? 'Edit Enviro Configuration' : 'Buat Enviro Configuration')
...
<div class="page-header">
    <div>
        <h1 class="page-header-title">{{ $quotation ? 'Edit Enviro Configuration #'.$quotation->id : 'Buat Enviro Configuration' }}</h1>
...
<form id="wc-form" autocomplete="off">
    ...
    <div class="d-flex justify-content-end gap-2 mb-4">
        <a href="{{ route('enviro-configuration.index') }}" class="btn btn-secondary">Batal</a>
...
const wcStoreUrl = '{{ route("enviro-configuration.store") }}';
const wcUpdateUrl = '{{ route("enviro-configuration.update", "__ID__") }}';
const wcIndexUrl = '{{ route("enviro-configuration.index") }}';
const wcSearchUrl = '{{ route("enviro-configuration.search-products") }}';
const wcFetchTaskUrl = '{{ route("enviro-configuration.fetch-task") }}';
const wcFetchTemplateUrl = '{{ route("enviro-configuration.fetch-template", "__ID__") }}';
