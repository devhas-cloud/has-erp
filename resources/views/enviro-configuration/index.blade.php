...
@section('title', 'Enviro Configuration')
@section('page-title', 'Enviro Configuration')

@section('content')
<div class="page-header">
    <div>
        <h1 class="page-header-title">Enviro Configuration</h1>
        <p class="page-header-sub">Kelola konfigurasi quotation (pH, Ammonia, COD, TSS dan Debit) dari task quote</p>
    </div>
    @if($canCreate)
    <div class="page-header-actions">
        <a href="{{ route('enviro-configuration.create') }}" class="btn-accent">
...
<div class="card-custom fade-in">
    ...
    <div class="card-body-custom p-2">
        <div class="table-responsive">
            <table id="enviro-config-table" class="table table-custom align-middle mb-0" style="width:100%">
                <thead>
                    <tr>
...
const wcShowUrl = '{{ route("enviro-configuration.show", "__ID__") }}';
const wcEditUrl = '{{ route("enviro-configuration.edit", "__ID__") }}';
const wcDeleteUrl = '{{ route("enviro-configuration.destroy", "__ID__") }}';
...
const wcShowUrlBase = '{{ route("enviro-configuration.show", "__ID__") }}';
...
function initWcTable() {
    ...
    wcTable = $('#enviro-config-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route("enviro-configuration.data") }}',
        order: [[1, 'desc']],
        columns: [
