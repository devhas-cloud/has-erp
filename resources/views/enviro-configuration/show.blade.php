...
<div class="page-header">
    <div>
        ...
        <p class="page-header-sub">Enviro Configuration dari Task Quote #{{ $quotation->task_id }}</p>
    </div>
    <div class="page-header-actions">
        ...
        @else
            <a href="{{ route('enviro-configuration.index') }}" class="btn btn-secondary btn-sm">
                <i class="fa fa-arrow-left me-1"></i> Kembali
            </a>
        @endif
        <a href="{{ route('enviro-configuration.pdf', $quotation->id) }}" target="_blank" class="btn-accent">
...
<div class="wc-action-bar justify-content-end">
    <a href="{{ route('enviro-configuration.edit', $quotation->id) }}" class="btn btn-primary btn-sm">
        ...
        <div class="card-custom mt-4">
            ...
            <div class="card-body-custom">
                ...
                <div class="alert alert-info py-2 px-3 mt-3 mb-0" style="font-size:12px">
                    ...
                    Aturan: user divisi Enviro (pembuat) tidak bisa approve dokumennya sendiri. Approval hanya dapat
                    dilakukan oleh user lain yang satu divisi dengan pembuat (divisi Enviro).
                </div>
            </div>
        </div>
    </div>
...
const wcSubmitUrl = '{{ route("enviro-configuration.submit", "__ID__") }}';
const wcApproveUrl = '{{ route("enviro-configuration.approve", "__ID__") }}';
const wcRejectUrl = '{{ route("enviro-configuration.reject", "__ID__") }}';
const wcUnlockUrl = '{{ route("enviro-configuration.unlock", "__ID__") }}';
const wcReviseUrl = '{{ route("enviro-configuration.revise", "__ID__") }}';
const wcVersionsUrl = '{{ route("enviro-configuration.versions", "__ID__") }}';
const wcEditUrl = '{{ route("enviro-configuration.edit", "__ID__") }}';
