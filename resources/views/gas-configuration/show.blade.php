...
<div class="page-header">
    <div>
        ...
        <p class="page-header-sub">Gas Configuration dari Task Quote #{{ $quotation->task_id }}</p>
    </div>
    <div class="page-header-actions">
        ...
        @endif
        <a href="{{ route('gas-configuration.pdf', $quotation->id) }}" target="_blank" class="btn-accent">
...
<div class="wc-action-bar justify-content-end">
    <a href="{{ route('gas-configuration.edit', $quotation->id) }}" class="btn btn-primary btn-sm">
        ...
        <div class="card-custom mt-4">
            ...
            <div class="card-body-custom">
                ...
                <div class="alert alert-info py-2 px-3 mt-3 mb-0" style="font-size:12px">
                    ...
                    Aturan: user divisi Gas (pembuat) tidak bisa approve dokumennya sendiri. Approval hanya dapat
                    dilakukan oleh user lain yang satu divisi dengan pembuat (divisi Gas).
                </div>
            </div>
        </div>
    </div>
...
const wcSubmitUrl = '{{ route("gas-configuration.submit", "__ID__") }}';
const wcApproveUrl = '{{ route("gas-configuration.approve", "__ID__") }}';
const wcRejectUrl = '{{ route("gas-configuration.reject", "__ID__") }}';
const wcUnlockUrl = '{{ route("gas-configuration.unlock", "__ID__") }}';
const wcReviseUrl = '{{ route("gas-configuration.revise", "__ID__") }}';
