...
@section('title', $quotation ? 'Edit Gas Configuration #'.$quotation->id : 'Buat Gas Configuration')
@section('page-title', $quotation ? 'Edit Gas Configuration' : 'Buat Gas Configuration')
...
<div class="page-header">
    <div>
        <h1 class="page-header-title">{{ $quotation ? 'Edit Gas Configuration #'.$quotation->id : 'Buat Gas Configuration' }}</h1>
    ...
    <div class="page-header-actions">
        <a href="{{ route('gas-configuration.index') }}" class="btn btn-secondary btn-sm">
...
<form id="wc-form" autocomplete="off">
    ...
    <div class="d-flex justify-content-end gap-2 mb-4">
        <a href="{{ route('gas-configuration.index') }}" class="btn btn-secondary">Batal</a>
...
const wcStoreUrl = '{{ route("gas-configuration.store") }}';
const wcUpdateUrl = '{{ route("gas-configuration.update", "__ID__") }}';
const wcIndexUrl = '{{ route("gas-configuration.index") }}';
const wcSearchUrl = '{{ route("gas-configuration.search-products") }}';
const wcFetchTaskUrl = '{{ route("gas-configuration.fetch-task") }}';
const wcFetchTemplateUrl = '{{ route("gas-configuration.fetch-template", "__ID__") }}';
