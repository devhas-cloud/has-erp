...
@section('title', 'IMS Configuration')
@section('page-title', 'IMS Configuration')
...
<div class="page-header">
    ...
    <div class="page-header-actions">
        <a href="{{ route('ims-configuration.create') }}" class="btn-accent">
...
const wcShowUrl = '{{ route("ims-configuration.show", "__ID__") }}';
const wcEditUrl = '{{ route("ims-configuration.edit", "__ID__") }}';
const wcDeleteUrl = '{{ route("ims-configuration.destroy", "__ID__") }}';
...
const wcShowUrlBase = '{{ route("ims-configuration.show", "__ID__") }}';
...
function initWcTable() {
    ...
    wcTable = $('#water-config-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route("ims-configuration.data") }}',
        order: [[1, 'desc']],
        columns: [
