...
class ImsConfigurationController extends Controller
{
    ...
    {
        return view('ims-configuration.index');
    }
    ...
    {
        $divisionId = Division::where('division_name', 'IMS')->value('id');

        // Hanya tampilkan versi terbaru tiap group milik divisi IMS.
        ...
        foreach ($configurations as $i => $quotation) {
            $data[] = [
                ...
                'division_name' => $quotation->division?->division_name ?? '—',
    ...
    public function edit($id)
    {
        ...
        if ($quotation->status !== QuoteConfiguration::STATUS_DRAFT) {
            return redirect()->route('ims-configuration.index')
    ...
    /**
     * Pencarian produk master_products (hanya aktif milik divisi IMS).
    ...
    public function show($id)
    {
        ...
        return view('ims-configuration.show', compact('quotation', 'isSameDivisionApprover', 'back'));
    }
